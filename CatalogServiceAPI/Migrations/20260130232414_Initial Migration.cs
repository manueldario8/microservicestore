        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatusActived = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Providers", x => x.Id);
                    table.UniqueConstraint("AK_Providers_Code", x => x.Code);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_Providers_ProviderCode",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_ProviderCode_ProductCode",
                table: "Products",
                columns: new[] { "ProviderCode", "ProductCode" },
                unique: true);
